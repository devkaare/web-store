...
func createTables(db *sql.DB) {
	...
	if _, err := db.Exec("CREATE TABLE IF NOT EXISTS cart_items (user_id SERIAL PRIMARY KEY, product_id INT NOT NULL, size TEXT NOT NULL, quantity INT NOT NULL)"); err != nil {
		log.Fatal(err)
	}
